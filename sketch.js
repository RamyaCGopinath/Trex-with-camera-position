...
function preload(){
  ...
  groundImage = loadAnimation("ground2.png","ground2.png");
...
function setup() {
 ...
 // gameOver.scale = 0.5;
  ...
  invisibleGround = createSprite(displayWidth/2,displayHeight-25,displayWidth,10);
...
function draw() {
  ...
  //displaying score
  textSize(30);
  text("Score: "+ score, displayWidth-250,300);
...
function spawnClouds() {
 ...
 if (frameCount % 80 === 0) {
    ...
    cloud.y = Math.round(random(200,displayHeight-300));
